      ...
      >
        ...
        <div className={styles.supportItemsContainer}>
          <div className={styles.supportItem}>
            <div className={styles.supportTextContainer}><p className="map-body"><strong>By purchasing this mobile app, you're doing your part to support the conservation and study of Great White Sharks. Thank you.</strong></p><p className="map-body">For the first time in New Zealand, supporting a conservation study of Great White Sharks is made easy and accessible for the general public via this interactive app.</p><p className="map-body">Enjoying the app? Want to see more sharks and locations? The support of the public is what makes this app possible.</p><p className="map-body"><strong>The more support the app gets, the better resourced we are to improve it and tag more sharks (meaning even more locations).</strong></p><p className="map-body">Now that you've purchased the app, leaving a review will help make this a reality. <em>Already left a review?</em> Thank you for your support!</p><p className="map-body">Interested in sponsoring a tag? E-mail <a href="mailto:sustainableoceansociety@gmail.com">sustainableoceansociety@gmail.com</a> for further details.</p></div>
          </div>
        </div>
      </div>
    </div>
